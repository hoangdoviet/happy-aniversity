...
interface ExperienceProps {
  ...
  cursorPosition?: { x: number; y: number; detected: boolean };
}
...
export const Experience: React.FC<ExperienceProps> = ({
  ...
  useFrame((_, delta) => {
    if (controlsRef.current && handPosition.detected) {
      ...
      // Normal hand-controlled camera (both modes)
  ...
  return (
    <>
      <OrbitControls
        ...
        minDistance={mode === TreeMode.CHAOS ? 15 : 10}
        maxDistance={mode === TreeMode.CHAOS ? 35 : 30}
        enableDamping
        dampingFactor={0.05}
        enabled={true}
      />
      ...
      <group position={[0, -5, 0]}>
        ...
        <Polaroids
          ...
          onClosestMediaChange={onClosestMediaChange}
          handPosition={cursorPosition || handPosition}
          onHoveredMediaChange={onHoveredMediaChange}
        />
        <TreeStar mode={mode} />
